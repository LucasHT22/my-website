      ...
      <header className={styles.header}>
        {home ? (
          <>
            ...
            <p className={utilStyles.obs0}>Creating the best experiences @ Hack SP | Hack Club | BRASA ‘26 | Sigmacamp Brazil ‘26 | LALA ‘25 | NYAS ‘25 | MIT BWSIx ‘25 | ICTP-SAIFR Young Scientists ‘25</p>
          </>
        ) : (
          <>
            <Link href="/">
